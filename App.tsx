        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white tracking-tight">物理 <span className="text-cyan-400">模拟器</span></h1>
              </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 items-end">
              ...
              <div className="space-y-1.5">
                 <label className="text-xs font-medium text-gray-400 flex justify-between">
                    <span>模拟速度</span>
                    <span className="text-cyan-400">{isPlaying ? globalSettings.timeScale.toFixed(1) + 'x' : '已暂停'}</span>
                 </label>
